...
from .views.web import RegisterView, VerifyOptTokenView, ForgotPasswordRequestView, ForgotPasswordRequestValidateView, ChangeForgotPasswordView, ChangePasswordView
