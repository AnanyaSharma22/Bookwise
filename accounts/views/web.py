...
from bookstore.core.decorators import anonymous_view, logged_user_view
...
class RegisterView(FormView):
    ...
    def form_valid(self, form):
        ...
        success_url = reverse_lazy("account:otpverify", kwargs={
...
class ForgotPasswordRequestView(FormView):
    ...
    def form_valid(self, form):
        ...
        redirect_to = reverse('account:forgot-password-request-otp-verify', kwargs={
            'encoded_token': form.get_encoded_token()})
...
class ForgotPasswordRequestValidateView(FormView):
    ...
    def form_valid(self, form):
        ...
        Runs when a form is valid
        '''
        return_url = reverse('account:forgot-password-reset',
    ...
    def get_success_url(self):
        ...
        Returns success url
        '''
        return reverse('account:forgot-password-reset')

@logged_user_view(redirect_to=reverse_lazy('account:login'))
